...
#include"blob_run.h"
//http://max.book118.com/html/2012/0614/2156416.shtm
...
void BLOB_run::run(char* track,char *video_name)
{
    CvCapture*                  pCap = NULL;
...
//./Blobs fg=FG_0s bd:hmin=0.08 bt=CC  btpp=Kalman bt_corr=PostProcRes btgen=RawTracks  track=a.txt btavi=b2.avi fgavi=f2.avi people.avi
int argc=11;
char* argv[11];
//argv[0]="./Blobs";
//argv[1]="fg=FG_0s";
...
//argv[6]="btgen=RawTracks";
//argv[7]="track=/home/xuefengmiao/smartcity/a.txt";
//argv[8]="btavi=b2.avi";
//argv[9]="fgavi=f2.avi";
//argv[10]="/home/xuefengmiao/smartcity/dongcemen_6_1280x720_30.avi";
argv[0]="./Blobs";
argv[1]="fg=FG_0s";
argv[2]="bd:hmin=0.08";
argv[3]="bt=CC";
...
//        printf("BlobTrackAnalysis:  %s\n", pBTAnalysisModule->nickname);
    ...
    {   /* Save state and release modules: */
        CvFileStorage* fs = NULL;
        savestate_name="savestate_name.yml";
        if(savestate_name)
        {
